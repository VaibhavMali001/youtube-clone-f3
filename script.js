...
async function fetchVideos(searchTerm, maxResult) {
  const loadingCircle = document.getElementById("loadingCircle"); //add this code in fetchVideos function for loading circle before the videos fetch
  loadingCircle.style.display = "block"; //add this code in fetchVideos function for loading circle before the videos fetch
  try {
    ...
    loadingCircle.style.display = "none"; // Hide loading circle after fetching
  }
}
